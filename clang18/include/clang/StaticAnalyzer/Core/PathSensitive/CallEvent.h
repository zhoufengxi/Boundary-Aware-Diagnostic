...
public:
  ...
  /// Returns a new state with the call's argument regions invalidated while
  /// honoring caller-provided invalidation traits.  This is intended for
  /// configurable API models that need the normal opaque-call invalidation
  /// behavior but must suppress escaping or preserve the contents of selected
  /// resources until a modeled outcome is known.
